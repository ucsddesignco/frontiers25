...
export async function POST(req: NextRequest){
    try{
        ...
        const requiredFields = ['user', 'author', 'font', 'shape', 'p_color', 'a_color'];
        ...
        /** Create the card **/
        const card = await createCard(body.user, body.author, body.font, body.shape, body.p_color, body.a_color);
