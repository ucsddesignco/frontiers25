  ...
  return (
    <>
      <div
        ...
        className={`${opacityClass} ${scaleClass} pointer-events-none fixed inset-0 z-[4] transition-[transform,opacity] duration-[0.25s] ease-in-out lg:hidden`}
      ></div>
      <div
        className={`${opacityClass} ${delayClass} pointer-events-none fixed inset-0 z-[4] bg-[rgb(233,233,233)] transition-opacity duration-[0.2s] ease-in-out`}
      ></div>
    </>
  );
}
