  ...
  return (
    <>
      <div
        ...
        className={`${opacityClass} ${scaleClass} duration-[0.25s] pointer-events-none fixed inset-0 z-[4] transition-[transform,opacity] ease-in-out lg:hidden`}
      ></div>
      <div
        className={`${opacityClass} ${delayClass} duration-[0.2s] pointer-events-none fixed inset-0 z-[4] bg-[rgb(233,233,233)] transition-opacity ease-in-out`}
      ></div>
    </>
  );
}
