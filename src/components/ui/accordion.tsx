...
>(({ className, children, borderStyle, ...props }, ref) => (
  <AccordionPrimitive.Content
    ...
    className={cn(
      ...
      'agp-4 text-md overflow-hidden border-x-[3px] border-b-[3px] border-[var(--card-accent-color)] bg-[var(--card-button-color)] transition-all data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down',
      className
    )}
    {...props}
  >
